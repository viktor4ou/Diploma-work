...
let generateShop = () => {
  return (shop.innerHTML = shopItemsData.filter((x) => x.id === "intel_i5_10400f")
    .map((x) => {
  ...
  <div class="container-fluid mb-2 text-end ">
    <p class="display-3 fw-bold text-center border-bottom pb-1 border-primary border-bottom-4">Intel Core i5-10400F</p>
    ...
    <div class="card " >
      <div class="card-body d-flex justify-content-center">
        <span>
          ...
          <div class="d-flex">
            <p href="#" class="card-link text-decoration-line-through" style="color: grey; text-decoration: line-through;">309лв.</p>
            <span class="text-danger" style="text-decoration: none;">&nbsp(-22%)</span>
          </div> 
        </span>
      </div>
      </div>
